...
class BLRscText : BLRscCommon {
	colorBackground[] = {0,0,0,0};
	type = CT_STATIC;
	style = ST_LEFT;
};

class BLRscStructuredText : BLRscText {
	type =  CT_STRUCTURED_TEXT;
	size = 0.03;
};

class BLRscPicture : BLRscCommon {
	style = ST_PICTURE;
};
...
class BLRscListBox : BLRscCommon {
	type = 5;
	style = 16;
	wholeHeight = 0.45;
	rowHeight = 0.045;
...
class BLRscListNBox : BLRscListBox {
	type = 102;
	columns[] = {0.3, 0.6, 0.7};
	drawSideArrows = 0;
