...
#define PERF_LOG(NAME) \
	private ['_max', '_sum', '_min', '_perf_history']; \
	_perf_history = [PERF_HISTORY, NAME] call CBA_fnc_hashGet; \
	_max = 0; \
	_sum = 0; \
	...
	diag_log format['%1: Perf time: %2, Max: %3, Avg: %4, Min: %5, Sum: %6', NAME, _perf_history select ((count _perf_history)-1), _max, _sum/count _perf_history, _min, _sum];