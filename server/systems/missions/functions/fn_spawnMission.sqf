...
[{
	...
	_missionName = [_this select 1, 1, '', [{}, '']] call BIS_fnc_param;
	_missionDesc = [_this select 1, 2, '', [{}, '']] call BIS_fnc_param;
	_missionLoc  = [_this select 1, 3, [], [[], {}, objNull]] call BIS_fnc_param;
	_missionRun  = [_this select 1, 4, {}, [{}]] call BIS_fnc_param;
