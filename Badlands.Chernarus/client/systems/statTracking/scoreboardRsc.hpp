...
class scoreboardRsc {
	...
	class controls{
		...
		class P2Bounty   : P1Bounty   { idc = IDC(1,3); y = playerLine(1); };
		class P2Kills    : P1Kills    { idc = IDC(1,4); y = playerLine(1); };
		class P2Deaths   : P1Deaths   { idc = IDC(1,5); y = playerLine(1); };
		class P2Score    : P1Score    { idc = IDC(1,6); y = playerLine(1); };
		...
		class P3Bounty   : P1Bounty   { idc = IDC(2,3); y = playerLine(2); };
		class P3Kills    : P1Kills    { idc = IDC(2,4); y = playerLine(2); };
		class P3Deaths   : P1Deaths   { idc = IDC(2,5); y = playerLine(2); };
		class P3Score    : P1Score    { idc = IDC(2,6); y = playerLine(2); };
		...
		class P4Bounty   : P1Bounty   { idc = IDC(3,3); y = playerLine(3); };
		class P4Kills    : P1Kills    { idc = IDC(3,4); y = playerLine(3); };
		class P4Deaths   : P1Deaths   { idc = IDC(3,5); y = playerLine(3); };
		class P4Score    : P1Score    { idc = IDC(3,6); y = playerLine(3); };
		...
		class P5Bounty   : P1Bounty   { idc = IDC(4,3); y = playerLine(4); };
		class P5Kills    : P1Kills    { idc = IDC(4,4); y = playerLine(4); };
		class P5Deaths   : P1Deaths   { idc = IDC(4,5); y = playerLine(4); };
		class P5Score    : P1Score    { idc = IDC(4,6); y = playerLine(4); };
		...
		class P6Bounty   : P1Bounty   { idc = IDC(5,3); y = playerLine(5); };
		class P6Kills    : P1Kills    { idc = IDC(5,4); y = playerLine(5); };
		class P6Deaths   : P1Deaths   { idc = IDC(5,5); y = playerLine(5); };
		class P6Score    : P1Score    { idc = IDC(5,6); y = playerLine(5); };
		...
		class P7Bounty   : P1Bounty   { idc = IDC(6,3); y = playerLine(6); };
		class P7Kills    : P1Kills    { idc = IDC(6,4); y = playerLine(6); };
		class P7Deaths   : P1Deaths   { idc = IDC(6,5); y = playerLine(6); };
		class P7Score    : P1Score    { idc = IDC(6,6); y = playerLine(6); };
		...
		class P8Bounty   : P1Bounty   { idc = IDC(7,3); y = playerLine(7); };
		class P8Kills    : P1Kills    { idc = IDC(7,4); y = playerLine(7); };
		class P8Deaths   : P1Deaths   { idc = IDC(7,5); y = playerLine(7); };
		class P8Score    : P1Score    { idc = IDC(7,6); y = playerLine(7); };
		...
		class P9Bounty   : P1Bounty   { idc = IDC(8,3); y = playerLine(8); };
		class P9Kills    : P1Kills    { idc = IDC(8,4); y = playerLine(8); };
		class P9Deaths   : P1Deaths   { idc = IDC(8,5); y = playerLine(8); };
		class P9Score    : P1Score    { idc = IDC(8,6); y = playerLine(8); };
		...
		class P10Bounty   : P1Bounty   { idc = IDC(9,3); y = playerLine(9); };
		class P10Kills    : P1Kills    { idc = IDC(9,4); y = playerLine(9); };
		class P10Deaths   : P1Deaths   { idc = IDC(9,5); y = playerLine(9); };
		class P10Score    : P1Score    { idc = IDC(9,6); y = playerLine(9); };
	};
};