...
call compile preprocessFileLineNumbers "client\systems\generalStore\items\fuelFull.sqf";
call compile preprocessFileLineNumbers "client\systems\generalStore\items\fuelEmpty.sqf";
[
