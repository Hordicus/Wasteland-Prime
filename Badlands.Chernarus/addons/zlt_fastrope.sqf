...
zlt_rope_helis = ["O_Heli_Light_02_unarmed_F","B_Heli_Light_01_F","I_Heli_light_03_unarmed_F","I_Heli_Transport_02_F","B_Heli_Transport_01_F","B_Heli_Transport_01_camo_F","B_Heli_Light_01_armed_F","O_Heli_Light_02_F","I_Heli_light_03_F","B_Heli_Attack_01_F","O_Heli_Attack_02_F","O_Heli_Attack_02_black_F"];
zlt_rope_helidata = 
[
	[
		["O_Heli_Light_02_unarmed_F", "O_Heli_Light_02_F","I_Heli_light_03_unarmed_F","I_Heli_light_03_F"],
		[1.35,1.35,-24.95],
		[-1.45,1.35,-24.95]
	],
	[
	...
	[
		["O_Heli_Attack_02_F","B_Heli_Attack_01_F","O_Heli_Attack_02_black_F"],
		[1.3,1.3,-25],
		[-1.3,1.3,-25]
	],
	[
...
zlt_fnc_fastropeaiunits = {
		...
		dostop (driver _heli );
		(driver _heli) setBehaviour "COMBAT"; 
		(driver _heli) setCombatMode "RED"; 
