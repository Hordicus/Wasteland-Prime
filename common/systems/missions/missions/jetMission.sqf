...
{
	_possible = [[] call BL_fnc_missionsConfig, 'jetRewards'] call CBA_fnc_hashGet;
	_locations = [[] call BL_fnc_missionsConfig, 'jetMissionLocations'] call CBA_fnc_hashGet;
...
// Function to call to start the mission
{
	...
	_grp createUnit ["O_Soldier_AA_F", _location, [], 0, "FORM"];
	_grp createUnit ["O_Soldier_AA_F", _location, [], 0, "FORM"];
	
	_grp createUnit ["O_sniper_F", _location, [], 0, "FORM"];
	_grp createUnit ["O_sniper_F", _location, [], 0, "FORM"];
