...
#define GEAR_itemslist_idc GEAR_idc_base + 1
#define GEAR_select_guns_idc GEAR_idc_base + 2
#define GEAR_select_launchers_idc GEAR_idc_base + 3
#define GEAR_select_items_idc GEAR_idc_base + 4
#define GEAR_items_attachments_ammo_idc GEAR_idc_base + 5
#define GEAR_select_wearables_idc GEAR_idc_base + 6
#define GEAR_select_ammo_idc GEAR_idc_base + 7
#define GEAR_select_attachments_idc GEAR_idc_base + 8
#define GEAR_select_uniform_idc GEAR_idc_base + 9
#define GEAR_select_vest_idc GEAR_idc_base + 10
#define GEAR_select_backpack_idc GEAR_idc_base + 11
#define GEAR_uniform_load_idc GEAR_idc_base + 12
...
#define GEAR_select_uniform_bg_idc GEAR_idc_base + 19
#define GEAR_select_vest_bg_idc GEAR_idc_base + 20
#define GEAR_select_backpack_bg_idc GEAR_idc_base + 21
#define GEAR_select_helmet_idc GEAR_idc_base + 22
#define GEAR_select_helmet_bg_idc GEAR_idc_base + 23
#define GEAR_select_glasses_bg_idc GEAR_idc_base + 24
#define GEAR_select_glasses_idc GEAR_idc_base + 25
#define GEAR_select_nvg_bg_idc GEAR_idc_base + 26
