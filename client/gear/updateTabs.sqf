...
_color1 = [0,0,0,1];
_color2  = [1,1,1,1];
_buttons = [GEAR_select_guns_idc, GEAR_select_launchers_idc, GEAR_select_items_idc, GEAR_select_wearables_idc, GEAR_select_ammo_idc, GEAR_select_attachments_idc];
_button_names = ['guns', 'launchers', 'items', 'wearables', 'ammo', 'attachments'];
_active_buttons = [
